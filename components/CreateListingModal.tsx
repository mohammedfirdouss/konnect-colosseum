...
const CreateListingModal = () => {
    ...
    const { getMarketplaceAddress, createListing, loading } = useMarketplace();
  ...
  const handleCreateListing = async () => {
    ...
    try {
      ...
      // Get marketplace and merchant addresses
      ...
      const [merchantPDA] = PublicKey.findProgramAddressSync(
        [Buffer.from('merchant'), marketplaceAddress.toBuffer(), publicKey.toBuffer()],
        new PublicKey("B5nTWLtcbWiMpG26vTMBdVMZw3DL2ewsXZid1SDGBZNa") // Program ID from IDL
      );
      ...
      const mintAddress = new PublicKey("So11111111111111111111111111111111111111112"); // Native SOL mint address
      ...
      if (tx === 'already-processed') {
        ...
        toast.success(`${listingName} has been listed on the marketplace!`, { id: 'create-listing' });
      }
      ...
      toast.error(`Failed to create listing: ${error.message}`, { id: 'create-listing' });
    }
  };
